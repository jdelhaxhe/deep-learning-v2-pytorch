...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        #First way : JD's way (matriciellement correct...)
        # hidden_error = None
        # hidden_error_term = output_error_term.dot(self.weights_hidden_to_output.T)
        # for i in range(len(hidden_outputs)):
        #     hidden_error_term[i] *= self.activation_function_prime(hidden_outputs[i])
